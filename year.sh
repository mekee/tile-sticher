...
if [ "$1" = "" ]; then
  echo "Missing year parameter"
    ...
    then
        ...
        /home/datasoft/anaconda3/bin/python scraper.py --poly poly.geojson --retries 1 --zoom 15 --url http://wpc.4693.edgecastcdn.net/004693/tiles/area/$1/Z{z}/{y}/{x}.png?v=20 --out-dir tiles/$1
